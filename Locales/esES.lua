...
L["ALERT_PRINT_SCOPE_DESC"] =
	"De quién son los lanzamientos que llegan a tu ventana. Mías te cubre a ti y a tu propia mascota; Todas cubre a todo el mundo en tu grupo. El sonido también sigue este ajuste, así que nunca oirás una alerta que no puedas ver."
L["ALERT_ANNOUNCE"] = "Anunciar al grupo"
L["ALERT_ANNOUNCE_DESC"] =
	"Envía esta alerta al chat de tu grupo o banda. Ir narrando lo que hacen los demás ante toda la banda es la forma más rápida de que un addon acabe cansando, así que este merece pensarlo antes de activarlo."
L["ALERT_ANNOUNCE_SCOPE_DESC"] =
	"De quién son los lanzamientos que van al chat de grupo o banda. Mías te cubre a ti y a tu propia mascota; Todas cubre a todo el mundo en tu grupo, tú incluido."
...
L["TAUNTS_SUCCESS_DESC"] =
	"Una provocación que ha entrado y le ha quitado el enemigo a otra persona. Una provocación sobre un enemigo que ya estaba pegando a quien provoca es un refresco de amenaza y no un rescate, así que esas se quedan calladas."
...
L["TAUNTS_FAILED_DESC"] =
	"Una provocación que ha fallado, ha sido resistida o ha tocado algo inmune. El enemigo no ha cambiado de manos, y nada en pantalla te lo dice."
...
L["FEARS_ALERT_DESC"] =
	"Un miedo que ha entrado y ha desperdigado el pull fuera del alcance del tanque. Solo cuenta que entre: un lanzamiento a secas, una resistencia y una inmunidad no movieron nada, así que ninguno de ellos se informa."
...
L["BAD_PET_ALERT_DESC"] =
	"Una mascota que le quita el enemigo al tanque con el lanzamiento automático activado, normalmente sin que su dueño se entere."
...
L["TANKING_TOOLS_COLD_OPENER_WINDOW_DESC"] =
	"Hasta qué punto de un pull sigue contando una habilidad evitada. El reloj arranca la primera vez que Control Freak ve a ese enemigo, y solo cuentan las habilidades: un ataque automático falla demasiado a menudo como para ser noticia."
...
L["TANKING_TOOLS_ARMOR_DESC"] =
	"Informa de cuánto ha tardado el grupo en pelar la armadura de un objetivo: cinco Desgarrar armadura o un Exponer armadura de pícaro. Activa un extra abajo y también esperará a ese, pero solo cuando alguien del grupo pueda lanzarlo de verdad."
...
L["TANKING_TOOLS_PARRY_DESC"] =
	"Quien recibe una parada de un enemigo al que no está tanqueando está colocado delante de él. Cada parada acelera el siguiente golpe de ese enemigo contra quien lo sostiene."
...
L["TANKING_TOOLS_PARRY_COOLDOWN_DESC"] =
	"Cuánto tiempo se queda callado un culpable tras hacer saltar un aviso de parada. Cubre el mensaje, el sonido, el anuncio y el susurro, porque a quien todavía no se ha movido no hace falta decírselo en cada golpe."
...
L["TAUNT_STOLEN"] = "¡Eh, que es mío! ¡%s usó %s contra %s!" -- parked; see Data/Default-Settings.lua
...
L["PARRY_WARNING"] = "¡Prisa por parada! ¡%s está delante de %s!"
L["PARRY_WHISPER"] =
...
L["ANNOYANCE_BUBBLE"] = "¡Qué pesadez! ¡%s usó %s en %s con %d%% de vida!"
